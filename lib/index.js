...
var ReactGoogleAutocomplete = function (_React$PureComponent) {
  _inherits(ReactGoogleAutocomplete, _React$PureComponent);
  ...
  _createClass(ReactGoogleAutocomplete, [{
    ...
    value: function componentDidMount() {
      ...
      this.autocomplete = new google.maps.places.Autocomplete(this.inputRef, config);
    ...
    value: function disableAutofill() {
      ...
      if (window.MutationObserver) {
        var observerHack = new MutationObserver(function () {
          ...
          if (_this2.inputRef) {
            _this2.inputRef.autocomplete = 'off';
          }
        });
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          _props2$textFieldProp = _props2.textFieldProps,
          textFieldProps = _props2$textFieldProp === undefined ? {} : _props2$textFieldProp,
          rest = _objectWithoutProperties(_props2, ['onPlaceSelected', 'types', 'componentRestrictions', 'bounds', 'textFieldProps']);

      return _react2.default.createElement(_TextField2.default, _extends({
        inputProps: rest,
        inputRef: function inputRef(ref) {
          return _this3.inputRef = ref;
        }
      }, textFieldProps));
    }
  }]);
...
var ReactCustomGoogleAutocomplete = exports.ReactCustomGoogleAutocomplete = function (_React$PureComponent2) {
  _inherits(ReactCustomGoogleAutocomplete, _React$PureComponent2);
    ...
    value: function componentDidMount() {
      ...
      if (this.props.input.value) {
        ...
        this.placeService.getDetails({ placeId: this.props.input.value }, function (e, status) {
          if (status === 'OK') {
            _this6.inputRef.value = e.formatted_address;
          }
        });
      }
    }
